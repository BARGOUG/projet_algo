...
//retourner la schema utilisé pour la construction de mot derive apartir de l'original 
void Verification_appartenance(string original, string derived_word){
    if(compare(original,derived_word)){
        cout << "le scheme utilise pour cette mot derive est : "+get_scheme(original,derived_word)<< endl;
    }else{
        cout << "le scheme nexist pas pour cette mot derive" <<endl;
    }
